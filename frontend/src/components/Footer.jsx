      ...
      <section className="section-container text-center">
        ...
        <div className="mt-6 flex justify-center gap-4">
          ...
          <a
            ...
            target="_blank"
            className="inline-flex items-center gap-2 rounded-full border border-base bg-card px-4 py-2 text-xs font-medium text-slate-700 shadow-sm hover:border-primary/50 hover:text-slate-900 dark:text-slate-500"
          >
            💬 WhatsApp
          </a>
        </div>
